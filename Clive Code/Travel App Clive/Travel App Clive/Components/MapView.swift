...
struct MapView: View {
    ...
    var body: some View {
        NavigationStack {
            Map(position: $cameraPosition, selection: $mapSelection, scope: locationSpace) {
                ...
                Marker("User Location", coordinate: .myLocation)
                    .tint(.red)
            ...
            .sheet(isPresented: $showDetails, onDismiss: {
                withAnimation(.snappy) {
                    if let boundingRect = route?.polyline.boundingMapRect, showRoute {
    ...
    func fetchLookAroundScenePreview() {
